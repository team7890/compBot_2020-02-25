...
public final class Constants {
    ...
    public static final class kPneumatics {
        ...
        public static final int iColorWheel = 3;    // not implemented (plugged)
        public static final int iIndexer = 4;       // not implemented (no solenoid yet)
    }

    public static final class kSpeedMults {
        // subsystem multipliers
        public static final double dIntakeMult = 0.6;
        public static final double dElevatorMult = 0.25;
        public static final double dTilterMult = 0.2;
        public static final double dWinchMult = 0.4;
    ...
    public static final class kFixedSpeeds {
        ...
        public static final double dLauncherMaxRPM = 5676;
